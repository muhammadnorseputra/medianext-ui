...
export default function Footer() {
	...
	return (
		<>
			<div className="inline-flex flex-1 w-full mt-5 justify-between items-center py-5 border-t border-gray-200 dark:border-gray-700 [&>*]:text-gray-400 dark:[&>*]:text-gray-400">
