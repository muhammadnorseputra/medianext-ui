...
const SingglePost: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap md:container px-0">
        <div className="mb-5 mt-3 px-6 md:mx-0 md:px-4 2xl:px-8">
          <div className="sticky top-3">
          <span className="border-b border-gray-200 py-1">Share</span>
          <ul className="flex items-center sm:justify-start flex-row sm:flex-row md:flex-row lg:flex-col mt-3 gap-y-4 gap-x-2">
            <li>
        ...
        <article className="w-full px-6 pb-8 lg:px-12 lg:max-w-4xl 2xl:max-w-6xl lg:border-l md:rounded-xl lg:rounded-none lg:dark:border-gray-700 border-gray-200 bg-white dark:bg-gray-800">
          {/* user info */}
             ...
             <div className="inline-flex items-center justify-between space-x-2 md:space-x-3 py-2 md:py-3 w-full mt-2 w-full bg-white dark:bg-gray-800">
              ...
              <div className="relative overflow-hidden rounded-xl aspect-video">
                <Image 
                  layout="fill" 
                  objectFit="cover"
                  className="bg-gradient-to-t from-gray-200 border-t-slate-400 border-b-slate-600 transition-transform group-hover:scale-105 duration-1000" 
                  alt={data[1].title} 
                  src={data[1].cover}/>
              </div>
          </div>
        ...
        <div className="px-6 lg:px-6 2xl:px-8 lg:border-l lg:border-gray-200 dark:lg:border-gray-700">
          <div ref={stickyRef} className="will-change-scroll">
            ...
            <div className="grid grid-cols md:grid-cols-2 lg:grid-cols-1 gap-y-3 gap-x-5">
            ...
            <div className="dark:border-gray-700 pb-5">
